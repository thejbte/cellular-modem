...
int main(void)
{
    ...
    RUN_TEST(test_modem_SocketSendDataHex);

    RUN_TEST(test_modem_SSLCfgSecLevel);
    RUN_TEST(test_modem_SSLCfgVersion);
    RUN_TEST(test_modem_SSLCfgCipherSuite);
    RUN_TEST(test_modem_SSLCfgPathCacert);
    RUN_TEST(test_modem_SSLCfgPathClientCert);
    RUN_TEST(test_modem_SSLCfgPathClientKeyCert);
    RUN_TEST(test_modem_SSLDeleteFileStorage);
    RUN_TEST(test_modem_SSLListFileStorage);
    RUN_TEST(test_modem_SSLUplCaCert);
    RUN_TEST(test_modem_SSLUplClientCert);
    RUN_TEST(test_modem_SSLUplKeyCert);
    RUN_TEST(test_modem_SSLSocketOpen);
    RUN_TEST(test_modem_SSLSocketGetStatus);
    RUN_TEST(test_modem_SSLSocketSendData);
    RUN_TEST(test_modem_SSLSocketGetRecv);
    RUN_TEST(test_modem_SSLSocketClose);
