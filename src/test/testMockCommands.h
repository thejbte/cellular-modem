...
#define CM_CMD_MOCK_QIURC_CONN_INCOMING_PDPDEACT_RESPONSE                "\r\n+QIURC: \"pdpdeact\",1\r\n\r\n+QIURC: \"incoming\",11,3,\"192.168.32.48\",63713\r\n" /*URC of Incoming Connection*/
#define CM_CMD_MOCK_QIRD_RESPONSE_HEX_STR                       "\r\n+QIRD: 9\r\n7EA02100020023037E\r\n\r\nOK\r\n"
#define CM_CMD_MOCK_QIRD_RESPONSE_HEX_STR_LARGE                 "\r\n+QIRD: 35\r\n7EA0210002002303939A7481801205018006018007040000000108040000000341187E\r\n\r\nOK\r\n"
#define CM_CMD_MOCK_QIURC_RECV_WITH_QISTATE_RESPONSE                "QIURC: \"recv\",11\r\nAT+QISTATE=1,11\r\r\n+QISTATE: 11,\"TCP INCOMING\",\"192.168.32.48\",55647,2020,2,1,3,0,\"uart1\"\r\n\r\nOK\r\n" /*URC of Incoming tcp*/
#define CM_CMD_MOCK_QISTATE_SERV_WITH_QISTATE_CONFIG_RESPONSE       "\"192.168.32.48\",62538\r\nAT+QISTATE=1,2\r\r\n+QISTATE: 2,\"TCP LISTENER\",\"10.101.234.65\",0,9999,3,1,2,0,\"uart1\"\r\n\r\nOK\r\n"

#define CM_CMD_MOCK_QIURC_RECV_WITH_QIACT_RESPONSE2                "\r\n+QIURC: \"recv\",11\r\nAT+QIACT?\r\r\n+QIACT: 1,1,1,\"10.101.234.65\"\r\n\r\nOK\r\n" /*URC of Incoming tcp*/
#define CM_CMD_MOCK_SSL_LISTFILE                                   "\r\n+QFLST: \"UFS:F_M12-1.bmp\",562554\r\n+QFLST: \"UFS:F_M12-10.bmp\",562554\r\n+QFLST: \"UFS:F_M12-11.bmp\",562554\r\n\r\nOK\r\n"
#define CM_CMD_MOCK_SSL_UPLFILE                                    "\r\n+QFUPL: 10,3938\r\n\r\nOK\r\n"
...
AT+QIDEACT=1
AT+CGATT=1
AT+QICSGP=1,1,"INTERNET.COMCEL.COM.CO","","",3
AT+QIACT=1
AT+QIACT?
AT
AT+QNWINFO
